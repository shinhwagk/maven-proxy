...
//  val aaaa = system.actorOf(Props[CounterService], name = "listeaaaner")
//  aaaa! "aaa"
...
//          println("xxxxxxxxxxxxxx"+"CounterService not available, lack of initial value")
...
//
//  def receive = LoggingReceive {
//    case Store(Entry(key, count)) => {println("z");throw new StorageException("Simulated store failure " + count);}
//    case "a" => {println("z");throw new StorageException("Simulated store failure " + count);}
